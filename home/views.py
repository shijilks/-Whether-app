...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=b253684f8b76ca8ec471b32ed43bf0da'
    PARAMS = {'units':'metric'}

    API_KEY =  'AIzaSyDLpS37ttg88qDJtoaP-OTwfoUVPC9Oa60'

    SEARCH_ENGINE_ID = '8133811aa8fda4364'
